...
class $OdontogramLocalTable extends OdontogramLocal
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [patientId, dataJson, lastUpdated, isSynced];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class OdontogramLocalData extends DataClass
  ...
  @override
  int get hashCode => Object.hash(patientId, dataJson, lastUpdated, isSynced);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $EvolutionsLocalTable extends EvolutionsLocal
  ...
  late final GeneratedColumn<String> professorId = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _professorNameMeta =
      const VerificationMeta('professorName');
  @override
  late final GeneratedColumn<String> professorName = GeneratedColumn<String>(
      'professor_name', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _descriptionMeta =
      const VerificationMeta('description');
  @override
  late final GeneratedColumn<String> description = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _isSignedByProfessorMeta =
      const VerificationMeta('isSignedByProfessor');
  @override
  late final GeneratedColumn<bool> isSignedByProfessor = GeneratedColumn<bool>(
      'is_signed_by_professor', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints: GeneratedColumn.constraintIsAlways(
          'CHECK ("is_signed_by_professor" IN (0, 1))'),
      defaultValue: const Constant(false));
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('professor_name')) {
      context.handle(
          ...
          professorName.isAcceptableOrUnknown(
              data['professor_name']!, _professorNameMeta));
    }
    if (data.containsKey('description')) {
      context.handle(
          _descriptionMeta,
    ...
    if (data.containsKey('is_signed_by_professor')) {
      context.handle(
          _isSignedByProfessorMeta,
          isSignedByProfessor.isAcceptableOrUnknown(
              data['is_signed_by_professor']!, _isSignedByProfessorMeta));
    }
  ...
  EvolutionsLocalData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return EvolutionsLocalData(
      ...
      professorName: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}professor_name']),
      description: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}description'])!,
      isSignedByProfessor: attachedDatabase.typeMapping.read(
          DriftSqlType.bool, data['${effectivePrefix}is_signed_by_professor'])!,
...
class EvolutionsLocalData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['description'] = Variable<String>(description);
    map['is_signed_by_professor'] = Variable<bool>(isSignedByProfessor);
  ...
  EvolutionsLocalCompanion toCompanion(bool nullToAbsent) {
    return EvolutionsLocalCompanion(
      ...
      isSignedByProfessor: Value(isSignedByProfessor),
  ...
  factory EvolutionsLocalData.fromJson(Map<String, dynamic> json,
    ...
    return EvolutionsLocalData(
      ...
      description: serializer.fromJson<String>(json['description']),
      isSignedByProfessor:
          serializer.fromJson<bool>(json['isSignedByProfessor']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'description': serializer.toJson<String>(description),
      'isSignedByProfessor': serializer.toJson<bool>(isSignedByProfessor),
  ...
  EvolutionsLocalData copyWith(
      ...
      EvolutionsLocalData(
        ...
        professorName:
            professorName.present ? professorName.value : this.professorName,
        description: description ?? this.description,
        isSignedByProfessor: isSignedByProfessor ?? this.isSignedByProfessor,
  ...
  EvolutionsLocalData copyWithCompanion(EvolutionsLocalCompanion data) {
    return EvolutionsLocalData(
      ...
      description:
          data.description.present ? data.description.value : this.description,
      isSignedByProfessor: data.isSignedByProfessor.present
          ? data.isSignedByProfessor.value
          : this.isSignedByProfessor,
  ...
  String toString() {
    return (StringBuffer('EvolutionsLocalData(')
          ...
          ..write('description: $description, ')
          ..write('isSignedByProfessor: $isSignedByProfessor, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is EvolutionsLocalData &&
          ...
          other.description == this.description &&
          other.isSignedByProfessor == this.isSignedByProfessor &&
...
class EvolutionsLocalCompanion extends UpdateCompanion<EvolutionsLocalData> {
  ...
  final Value<String> description;
  final Value<bool> isSignedByProfessor;
  ...
  const EvolutionsLocalCompanion({
    ...
    this.description = const Value.absent(),
    this.isSignedByProfessor = const Value.absent(),
  ...
  static Insertable<EvolutionsLocalData> custom({
    ...
    Expression<String>? description,
    Expression<bool>? isSignedByProfessor,
    ...
    return RawValuesInsertable({
      ...
      if (description != null) 'description': description,
      if (isSignedByProfessor != null)
        'is_signed_by_professor': isSignedByProfessor,
  ...
  EvolutionsLocalCompanion copyWith(
      ...
      Value<String>? description,
      Value<bool>? isSignedByProfessor,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isSignedByProfessor.present) {
      map['is_signed_by_professor'] = Variable<bool>(isSignedByProfessor.value);
    }
    if (signedAt.present) {
...
class $$EvolutionsLocalTableFilterComposer
  ...
  ColumnFilters<String> get professorName => $composableBuilder(
      column: $table.professorName, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get description => $composableBuilder(
      column: $table.description, builder: (column) => ColumnFilters(column));

  ColumnFilters<bool> get isSignedByProfessor => $composableBuilder(
      column: $table.isSignedByProfessor,
...
class $$EvolutionsLocalTableOrderingComposer
  ...
  ColumnOrderings<bool> get isSignedByProfessor => $composableBuilder(
      column: $table.isSignedByProfessor,
      builder: (column) => ColumnOrderings(column));
...
class $$EvolutionsLocalTableAnnotationComposer
  ...
  GeneratedColumn<String> get professorName => $composableBuilder(
      column: $table.professorName, builder: (column) => column);

  GeneratedColumn<String> get description => $composableBuilder(
      column: $table.description, builder: (column) => column);

  GeneratedColumn<bool> get isSignedByProfessor => $composableBuilder(
      column: $table.isSignedByProfessor, builder: (column) => column);
  ...
  $$EvolutionsLocalTableTableManager(
      ...
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<String?> professorName = const Value.absent(),
            Value<String> description = const Value.absent(),
            Value<bool> isSignedByProfessor = const Value.absent(),
            Value<DateTime?> signedAt = const Value.absent(),
            Value<DateTime> createdAt = const Value.absent(),
            Value<String?> clinicName = const Value.absent(),
            Value<bool> isSynced = const Value.absent(),
            ...
            description: description,
            isSignedByProfessor: isSignedByProfessor,
            signedAt: signedAt,
            createdAt: createdAt,
